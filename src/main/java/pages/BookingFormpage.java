...
public class BookingFormpage extends ProjectSpecificationMethod {
	...
	public BookingFormpage firstname() {
		...
		findElement("Xpath", "//input[@data-testid='first-inputbox-contact-details']").sendKeys("Boopathi");
		return this;
	}
	...
	public BookingFormpage lastname() {
		...
		findElement("Xpath", "//input[@data-testid='last-inputbox-contact-details']").sendKeys("T");
		return this;
	}
	...
	public BookingFormpage contact_Number() {
		...
		findElement("Xpath", "//input[@data-testid='contact-number-input-box']").sendKeys("9688806199");
		return this;
	...
	public BookingFormpage email_Id() {
		...
		findElement("Xpath", "//input[@data-testid='emailAddress-inputbox-contact-details']").sendKeys("boopathi13456.com");
		return this;
	}
